...
int main(int argc, char *argv[])
{
	...
	// Load Remote Agent (non-blocking)
	LoadRemoteAgent(argc, argv);

	int result = StartServer(cmdline) == LAUNCHER_OK ? EXIT_SUCCESS : EXIT_FAILURE;
